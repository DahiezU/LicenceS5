...
int main(int argc, char** argv){
   ...
   /* creer_benjamin(ma_table, "1.3");
    ...
    //afficher_entree(ma_table->le_frere_suivant->le_premier_fils->le_frere_suivant->le_frere_suivant->le_frere_suivant);
   // remonter(ma_table->le_frere_suivant->le_premier_fils->le_frere_suivant->le_frere_suivant->le_frere_suivant);
   // afficher_table(ma_table, 0);
    //afficher_entree(ma_table->le_frere_suivant->le_frere_suivant);
    //afficher_entree(ma_table->le_frere_suivant->le_frere_suivant);
 //afficher_entree(ma_table->le_frere_suivant->le_dernier_fils);
    //afficher_entree(ma_table->le_frere_suivant->le_frere_suivant);
    //decaler_sur_partie(ma_table->le_frere_suivant->le_premier_fils->le_frere_suivant);

   
    //afficher_entree(ma_table->le_frere_suivant->le_frere_suivant);
   // descendre(ma_table->le_frere_suivant->le_frere_suivant->le_frere_suivant);
    
    //afficher_entree(ma_table->le_frere_suivant);
    //afficher_entree(ma_table->le_frere_suivant->le_premier_fils); 
   // printf("5eme affichage\n");
    //supprimer_entree(&ma_table);
    //remonter(ma_table->le_frere_suivant->le_premier_fils);
    //remonter(ma_table->le_frere_suivant->le_frere_suivant->le_dernier_fils);
    
    //afficher_entree(ma_table->le_frere_suivant->le_frere_suivant->le_dernier_fils);
    //afficher_entree(ma_table->le_frere_suivant->le_frere_suivant->le_frere_suivant->le_frere_suivant->le_frere_suivant->le_frere_suivant);
    //remonter(ma_table->le_frere_suivant->le_dernier_fils);
    //remonter(ma_table->le_frere_suivant->le_dernier_fils);
    //remonter(ma_table->le_frere_suivant->le_premier_fils);
   // afficher_table(ma_table, 0);
    /* descendre 1 */
